            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php echo $this->lang->line('add_new_sms_configuration'); ?></h3>
                    </div>
                    <form action="<?php echo site_url('smsconfig/create') ?>"  id="employeeform" name="employeeform" method="post"  class="form-horizontal form-label-left"  accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="username" name="username" placeholder="" type="text" class="form-control col-md-7 col-xs-12"  value="<?php echo set_value('username'); ?>" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="password" name="password" placeholder="" type="password" class="form-control col-md-7 col-xs-12"  value="<?php echo set_value('password'); ?>" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="url" name="url" placeholder="" type="text" class="form-control col-md-7 col-xs-12"  value="<?php echo set_value('url'); ?>" />
