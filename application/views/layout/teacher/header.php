    ...
    <aside class="main-sidebar">                
        ...
        <li><a href=""><span href="#" >
            ...
            <li class="treeview <?php echo set_Topmenu('Fees Collection'); ?>">
                ...
                <ul class="treeview-menu">
                    <li class="<?php echo set_Submenu('studentfee/index'); ?>"><a href="<?php echo base_url(); ?>teacher/studentfee"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('collect_fees'); ?></a></li>
                    <li class="<?php echo set_Submenu('feemaster/index'); ?>"><a href="<?php echo base_url(); ?>teacher/feemaster"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('fees_master'); ?></a></li>
                    <li class="<?php echo set_Submenu('feetype/index'); ?>"><a href="<?php echo base_url(); ?>teacher/feetype"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('fees_type'); ?></a></li>
                     <li class="<?php echo set_Submenu('feecategory/index'); ?>"><a href="<?php echo base_url(); ?>teacher/feecategory"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('fee_category'); ?></a></li>
                    <li class="<?php echo set_Submenu('studentfee/searchpayment'); ?>"><a href="<?php echo base_url(); ?>teacher/studentfee/searchpayment"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('search_fees_payment'); ?></a></li>
                    <li class="<?php echo set_Submenu('studentfee/feesearch'); ?>"><a href="<?php echo base_url(); ?>teacher/studentfee/feesearch"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('search_due_fees'); ?> </a></li>
                    <li class="<?php echo set_Submenu('studentfee/reportbyname'); ?>"><a href="<?php echo base_url(); ?>teacher/studentfee/reportbyname"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('fees_statement'); ?></a></li>
                    <li class="<?php echo set_Submenu('transaction/studentacademicreport'); ?>"><a href="<?php echo base_url(); ?>teacher/transaction/studentacademicreport"><i class="fa fa-angle-double-right"></i>
                ...
                <li class="treeview <?php echo set_Topmenu('Library'); ?>">
                    ...
                    <ul class="treeview-menu">
                        <li class="<?php echo set_Submenu('book/index'); ?>"><a href="<?php echo base_url(); ?>teacher/book"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('books'); ?></a></li>
                    ...
                    <li class="treeview <?php echo set_Topmenu('Reports'); ?>">
                        ...
                        <ul class="treeview-menu">
                            <li class="<?php echo set_Submenu('student/studentreport'); ?>"><a href="<?php echo base_url(); ?>teacher/student/studentreport"><i class="fa fa-angle-double-right"></i>
                                ...
                                <li class="<?php echo set_Submenu('reportbyname/index'); ?>"><a href="<?php echo base_url(); ?>teacher/studentfee/reportbyname"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('fees_statement'); ?></a></li>
                                <li class="<?php echo set_Submenu('transaction/studentacademicreport'); ?>"><a href="<?php echo base_url(); ?>teacher/transaction/studentacademicreport"><i class="fa fa-angle-double-right"></i>
                                    <?php echo $this->lang->line('balance_fees_report'); ?></a></li>  
                                    <li class="<?php echo set_Submenu('stuattendence/classattendencereport'); ?>"><a href="<?php echo base_url(); ?>teacher/stuattendence/classattendencereport"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('attendance_report'); ?></a></li>
