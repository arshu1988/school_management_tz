            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="">
                            <div class="col-md-12">
                                <form role="form" action="<?php echo site_url('student/studentreport') ?>" method="post" class="form-horizontal">
                    ...
                    <div class="box box-info">
                        <div class="box-header with-border">
                            ...
                            <div class="box-tools pull-right">
                                <a class="btn bg-orange btn-sm" href="<?php echo base_url() ?>report/pdfStudentListDifferentCriteria?class_id=<?php echo $class_id; ?>&&section_id=<?php echo $section_id; ?>&&category_id=<?php echo $category_id; ?>&&gender=<?php echo $gender; ?>&&rte=<?php echo $rte_status; ?>"><i class="fa fa-file-pdf-o"></i> <?php echo $this->lang->line('download_pdf'); ?></a></div>
                        </div>
