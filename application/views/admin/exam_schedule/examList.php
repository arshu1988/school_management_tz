                ...
                <div class="col-md-12">
                    ...
                    if (isset($examSchedule)) {
                        ...
                        <div class="box box-info">
                            <div class="box-header with-border">
                                <h3 class="box-title"><i class="fa fa-list"></i> <?php echo $this->lang->line('exam_list'); ?> </h3>
                                <div class="box-tools pull-right">
                                </div>
                            </div>
                                            ...
                                            foreach ($examSchedule as $exam) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="pull-right">
                                                        ...
                                                        <a class="btn btn-primary btn-sm" href="<?php echo site_url('report/pdfExamschdule/' . $exam['exam_id'] . "/" . $section_id . "/" . $class_id) ?>"  class="schedule_modal" data-toggle="tooltip" title="<?php echo $this->lang->line('download'); ?>">
                                                            <i class="fa fa-download"></i> <?php echo $this->lang->line('pdf'); ?>
                                                        </a>
                                                    </td>
    ...
    $(document).on('click', '.schedule_modal', function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                data += "<p class='lead text text-center'><?php echo $this->lang->line('class'); ?>: " + classname + "(" + sectionname + ")</p>";
