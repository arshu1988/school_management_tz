                    ...
                    <form action="<?php echo site_url("admin/expensehead/edit/" . $id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input id="expensehead" name="expensehead" placeholder="expensehead" type="text" class="form-control"  value="<?php echo set_value('expensehead', $expensehead['exp_category']); ?>" />
