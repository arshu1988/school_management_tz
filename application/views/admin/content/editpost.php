...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="glyphicon glyphicon-th"></i> <?php echo $this->lang->line('manage'); ?> <small><?php echo $this->lang->line('student_fees'); ?></small>        </h1>
    </section>
    <!-- Main content -->
...
content_title'); ?></label>
                                <input id="content_title" name="content_title" placeholder="content_title" type="text" class="form-control"  value="<?php echo set_value('content_title', $editpost['content_title']); ?>" />
