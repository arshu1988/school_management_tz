                        ...
                        <div class="box-header with-border">
                            ...
                            <div class="pull-right box-tools">
                                ...
                                if ($examSchedule['status'] == "yes") {
                                    ...
                                    <a href="<?php echo base_url() ?>report/marksreport/<?php echo $exam_id; ?>/<?php
                                    echo
                                    $class_id;
                                    ?>/<?php echo $section_id; ?>" class="btn bg-orange btn-sm pull-right" style="margin-right: 5px;"><i class="fa fa-download"></i> <?php echo $this->lang->line('download_pdf'); ?></a>
                                   <?php }
                                   ?>
                            </div>
                        </div>
...
if($exam_schedule['exam_type']!='Co-Curriculum'){                                                                    
?>
                                                                    <th>
                                                                        <?php
