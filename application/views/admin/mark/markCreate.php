...
<div class="checkbox">
                                                                        <label><input type="checkbox" name="student_absent<?php echo $student['student_id'] . "_" . $exam_schedule['exam_schedule_id']; ?>" value="OPT" <?php if ($exam_schedule['attendence'] == "OPT") echo "checked"; ?>>Opt</label>
                                                                    </div>
