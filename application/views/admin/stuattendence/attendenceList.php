<?php  ?><style type="text/css">
    ...
    <option <?php if ($month == 1) {echo "selected =selected";}?> value="1">Janaury</option>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($resultlist as $key => $value) { 
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" name="working_days" value="<?php echo $value['working_days']; ?>">


                                                    </td>
<td>
                                                        <input type="text" name="attended_days" value="<?php echo $value['attended_days']; ?>">
