...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-money"></i> <?php echo $this->lang->line('system_settings'); ?>
        </h1>
    </section>   
            ...
            <div class="col-md-12">             
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php echo $this->lang->line('paypal_setting'); ?></h3>
                    </div>   
                    <form id="form1" action="<?php echo base_url() ?>admin/paymentsettings"  id="employeeform" name="employeeform" class="form-horizontal form-label-left" method="post" accept-charset="utf-8">
