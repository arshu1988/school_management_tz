            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="box box-primary" id="vehicle">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('vehicle_list'); ?></h3>
                            <div class="box-tools pull-right">
                                <button type='button' class="btn btn-default btn-sm pull-right no-print" onclick="printDiv('#vehicle');"><i class="fa fa-print"></i></button>
                            </div>
                        </div>
                        <div class="box-body">
