                    ...
                    <form action="<?php echo site_url("admin/subject/edit/" . $id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input id="category" name="name" placeholder="" type="text" class="form-control"  value="<?php echo set_value('name', $subject['name']); ?>" />
...
<label class="radio-inline">
                                    <input type="radio" name="type" <?php if (set_value('type') == "Co-Curriculum") echo "checked"; ?> value="Co-Curriculum">Co-Curriculum
                                </label>
                ...
                <div class="box box-primary" id="sublist">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            <button type='button' class="btn btn-default btn-sm pull-right no-print" onclick="printDiv('#sublist');"><i class="fa fa-print"></i></button>
                        </div>
                    </div>
                    <div class="box-body">
