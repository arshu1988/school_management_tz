                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        if (empty($resultlist)) {
                                            ?>
                                            <tr>
                                                <td colspan="5" class="text-danger text-center">No Transaction Found.</td>
                                            ...
                                            foreach ($resultlist as $student) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="pull-right">
                                                        ...
                                                        <a href="<?php echo base_url(); ?>teacher/studentfee/addfee/<?php echo $student['id'] ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('add_fees'); ?>">
