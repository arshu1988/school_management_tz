            ...
            <div class="col-md-12">                
                <div class="box box-primary" id="study_material">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php echo $this->lang->line('study_material_list'); ?></h3>
                        <div class="box-tools pull-right">
                            <button type='button' class="btn btn-default btn-sm pull-right no-print" onclick="printDiv('#study_material');"><i class="fa fa-print"></i></button>
                        </div>
                    </div>
                    <div class="box-body">
