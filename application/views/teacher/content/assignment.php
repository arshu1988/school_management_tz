            ...
            <div class="col-md-12">              
                <div class="box box-primary" id="assign">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php echo $this->lang->line('assignment_list'); ?></h3>
                        <div class="box-tools pull-right">
                            <button type='button' class="btn btn-default btn-sm pull-right no-print" onclick="printDiv('#assign');"><i class="fa fa-print"></i></button>
                        </div>
                    </div>
                    <div class="box-body">
