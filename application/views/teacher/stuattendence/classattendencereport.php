...
if (isset($resultlist)) {    
                    ...
                    <div class="box box-info" id="attendencelist">
                        <div class="box-header with-border" >
                            ...
                            <div class="box-tools pull-right">
                                <button type='button' class="btn btn-default btn-sm pull-right no-print" onclick="printDiv('#attendencelist');"><i class="fa fa-print"></i></button>
                            </div>
                        </div>
    ...
    ?>
                            ...
                            if (!empty($resultlist)) {                               
                                ...
                                <table class="table table-hover table-striped table-bordered xyz">
                                    <thead>
                                        <tr>
                                            <th>
