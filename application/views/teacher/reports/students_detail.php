                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td  style=" padding: 10px 20px;
                                 ...
                                 font-size: 1.2em;
                                 white-space: nowrap;
                                 border-top: 1px solid #AAAAAA; "><b><?php $tm = number_format($target_amount, 2, '.', ',');
                    echo $currency_symbol . $tm;
                        ...
                        <tr>
                            ...
                            <td  style=" padding: 10px 20px;
                                 ...
                                 font-size: 1.2em;
                                 white-space: nowrap;
                                 border-top: 1px solid #AAAAAA; "><b><?php $da = number_format($deposite_amount, 2, '.', ',');
                        ...
                        <tr>
                            ...
                            <td  style=" padding: 10px 20px;
                                 ...
                                 font-size: 1.2em;
                                 white-space: nowrap;
                                 border-top: 1px solid #AAAAAA; "><b><?php $tm_da = number_format(($target_amount - $deposite_amount), 2, '.', ',');
