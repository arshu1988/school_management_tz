                                        ...
                                        foreach ($examSchedule as $exam) {                                          
                                            ...
                                            <tr>
                                                ...
                                                <td class="pull-right">
                                                    ...
                                                    <a class="btn btn-primary btn-sm" href="<?php echo site_url('teacher/report/pdfExamschdule/' . $exam['exam_id'] . "/" . $section_id . "/" . $class_id) ?>"  class="schedule_modal" data-toggle="tooltip" title="<?php echo $this->lang->line('download'); ?>">
