    ...
    <section class="content-header">
        ...
        <section class="content">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input id="admission_no" name="admission_no" placeholder="" type="text" class="form-control"  value="<?php echo set_value('admission_no'); ?>" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-xs-12">
                                        ...
                                        <div class="row">
                                            <div class="">
                                                <div class="col-md-2">
                                                    <button type="button"  class="btn btn-sm btn-primary mysiblings"><i class="fa fa-plus"></i> <?php echo $this->lang->line('add'); ?> <?php echo $this->lang->line('sibling'); ?></button>
                                            ...
                                            <div class="panel box box-success">
                                                ...
                                                <div id="collapseOne" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                                                    <div class="box-body">
                                                        ...
                                                        <h4><?php echo $this->lang->line('student'); ?> <?php echo $this->lang->line('address'); ?> <?php echo $this->lang->line('details'); ?></h4><hr>
                                                        <div class="row">
                                                            <div class="">
                                                                <div class="col-md-6">
                                                                    <div class="checkbox">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('transport_fees'); ?></label>
                                                                    <input id="transport_fees" name="transport_fees" placeholder="" type="text" class="form-control"  value="<?php echo set_value('transport_fees', 0); ?>"  />
                                                                    <span class="text-danger"><?php echo form_error('transport_fees'); ?></span>
                                                                </div>
                                                            </div>
                                                        </div>
            ...
            <script type="text/javascript">
                ...
                $(document).on('change', '#vehroute_id', function (e) {
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <label for="inputPassword3" class="col-sm-2 control-label"><?php echo $this->lang->line('student_name'); ?>
</label>
