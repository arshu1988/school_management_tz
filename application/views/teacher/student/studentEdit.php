                                ...
                                <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-xs-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="transport_fees" name="transport_fees" placeholder="" type="text" class="form-control"  value="<?php echo set_value('transport_fees', $student['transport_fees']); ?>"  />
                                                        <span class="text-danger"><?php echo form_error('transport_fees'); ?></span>
                                                    </div>
                                                </div>
                                            </div>
                                            <h4><?php echo $this->lang->line('parent_guardian_detail'); ?></h4>
                                            <h3 class="box-title"><?php echo form_error('parent_guardian_detail'); ?></h3><hr>
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                            ...
                                            <div class="box-header">
                                                <h3 class="box-title"><?php echo $this->lang->line('address_details'); ?></h3><hr>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <label>
                                            ...
                                            <div class="box-header">
                                                <h3 class="box-title"><?php echo $this->lang->line('miscellaneous_details'); ?></h3><hr>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
