        ...
        <div class="row">
            <div class="col-md-4">               
                <div class="box box-primary">
                    ...
                    <form id="form1" action="<?php echo site_url('feemaster') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                        <div class="box-body">
                            <?php
            ...
            <div class="col-md-8">             
                <div class="box box-warning" id="fee_master">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php echo $this->lang->line('fees_master_list'). " : " . $this->setting_model->getCurrentSessionName(); ?></h3>
                        <div class="box-tools pull-right">
                        <button type='button' class="btn btn-default btn-sm pull-right no-print" id="print_div"><i class="fa fa-print"></i></button>
                                        ...
                                        foreach ($feemasterlist as $feemaster) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-date pull-right no-print">
                                                    <a href="<?php echo base_url(); ?>feemaster/edit/<?php echo $feemaster['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                                        <i class="fa fa-pencil"></i>
                                                    </a>
                                                    <a href="<?php echo base_url(); ?>feemaster/delete/<?php echo $feemaster['id'] ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('Are you sure you want to delete this item?');">
