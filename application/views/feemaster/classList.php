                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="mailbox-controls">
                            <a href="<?php echo base_url(); ?>classes/create" class="btn btn-primary btn-sm checkbox-toggle addcourse" data-toggle="tooltip" title="<?php echo $this->lang->line('add_class'); ?>" ><i class="fa fa-plus"></i> <?php echo $this->lang->line('add_class'); ?></a>
                                    ...
                                    foreach ($classlist as $class) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-date">
                                                <a href="<?php echo base_url(); ?>classes/view/<?php echo $class['id'] ?>" class="btn btn-info btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('show'); ?>" >
