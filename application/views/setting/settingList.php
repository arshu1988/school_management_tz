                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body no-padding">
                        ...
                        <div class="row" style="padding: 5px;">
                            <div class="col-md-3">
                                <?php
                                if ($settinglist[0]['board_image'] == "") {
                                    ?>
                                    <img src="<?php echo base_url() ?>uploads/school_content/logo/images.png" class="img-thumbnail" alt="Cinque Terre" width="304" height="236">
                                    <?php
                                } else {
                                    ?>
                                    <img src="<?php echo base_url() ?>uploads/school_content/logo/<?php echo $settinglist[0]['board_image']; ?>" class="img-thumbnail" alt="Cinque Terre" width="304" height="236">
                                    <?php
                                }
                                ?>
                                <br/>
                                <br/>
                                <a class="btn btn-sm btn-primary col-md-offset-4" href="<?php echo base_url() ?>schsettings/editLogo/<?php echo $settinglist[0]['id']; ?>?board_image=yes"><i class="fa fa-picture-o"></i> Edit Board Logo</a>
                                <br>
                                <br>
                            </div>
                        </div>
