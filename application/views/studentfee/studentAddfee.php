                                            ...
                                            <table class="table table-striped">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th  class="text text-right">Amount Paid</th>
...
$due_amount = "0";
                                                    foreach ($student_due_fee as $key => $fee) {                                 
                                                        if($fee['category']=='' || is_null($fee['category'])){
                                                            continue;
                                                        }
                     ...
                     $payment_status =  "<span class='label label-success'>".$this->lang->line('paid')."</span>";
                                                        ...
                                                        }else if ($fee['amount_paid'] < $fee['amount']) {
$deposite_amount = $deposite_amount + $fee['amount_paid'];
$due_amount =$due_amount + $fee['amount'];
                                                            $cls = "text-red";
                                                            $payment_status = "<span class='label label-warning'>Part Paid</span>";
                                                        } else {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="<?php echo $cls; ?>"><?php
                                                                ...
                                                                <td class="text text-right"><?php echo !is_null($fee['amount_paid'])?($currency_symbol . $fee['amount_paid']):""; ?></td>
                                                                ...
                                                                <td class="<?php echo $cls; ?>"><?php
                                                                    if ($fee['date'] == "xxx" || $fee['amount_paid'] < $fee['amount']) {
                                                                        ?>
                                                                        <button type="button" data-student-session-id="<?php echo $student['student_session_id'] ?>" data-amount="<?php echo $fee['amount'] ?>" data-amount_paid="<?php echo $fee['amount_paid'] ?>" data-type="<?php echo $fee['type'] ?>" data-category="<?php echo $fee['category']; ?>" data-feemasterid="<?php echo $fee['feemastersid']; ?>" data-invoiceno="<?php echo $fee['invoiceno']; ?>" class="btn btn-xs btn-primary pull-right myCollectFeeBtn"><i class="fa fa-plus-circle"></i>  <?php echo $this->lang->line('add_fees'); ?></button>
                                                                        <?php
                                                                    } else {
                                                                        ?>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <th><?php echo 'Total Due Fees'; ?> :</th>
                                                                    <td><?php echo ($currency_symbol . number_format(($due_amount-$deposite_amount) , 2)); ?></td>
                                                                </tr>
                                                                <tr>
                                                                ...
                                                                <table class="table table-striped">
                                                                    <thead>
                                                                        <tr>
                                                                            ...
                                                                            <th><?php echo $this->lang->line('date'); ?></th>
                                                                            <th class="text text-center"><?php echo $this->lang->line('mode'); ?></th>
<th class="text text-right"><?php echo $this->lang->line('month'); ?></th>
<th class="text text-right">Year</th>                                                                            
<th class="text text-right"><?php echo $this->lang->line('amount'); ?></th>
                                                                            <th class="text text-right"><?php echo $this->lang->line('fine'); ?></th>
                                                                            <th class="text text-right"><?php echo $this->lang->line('total'); ?></th>
                                                                        </tr>
...
<tr>
                                                                        <th style="width:50%">Transport Fees Per Month:</th>
                                                                        <td><?php echo number_format(($student['transport_fees'])); ?>
<input type="hidden" id="fees_per_month" value="<?php echo number_format(($student['transport_fees'])); ?>">
</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th><?php echo $this->lang->line('total_paid_fees'); ?> :</th>
                                ...
                                <script type="text/javascript">
                                    ...
                                    $(".myCollectFeeBtn").click(function () {
                                        ...
                                        $('.modal_amount_paid').val(amount_paid);
                                                ...
                                                <div class="form-horizontal">
                                                    <div class="box-body">
                                                      <input  type="hidden" class="form-control" id="guardian_phone"  value="<?php echo $student['guardian_phone'] ?>" readonly="readonly"/>
                                                        ...
                                                        <input  type="hidden" class="form-control" id="invoiceno"  value="0" readonly="readonly"/>
                                                        ...
                                                        <div class="form-group">
                                                            <label for="inputPassword" class="col-sm-3 control-label">Amount Paid</label>
                                                            <div class="col-sm-9">
                                                                <div class="">
                                                                    <input type="number" class="form-control modal_amount_paid" id="amount_paid" value="0">
                                                                    <!-- <span class="input-group-addon">.00</span> -->
                                                                </div>
...
<div class="form-group">
                                                            <label for="inputEmail3" class="col-sm-2 control-label"><?php echo $this->lang->line('month'); ?></label>
                                                            <div class="col-sm-10">
                                                                <select class="form-control month" id="transport_month" name="transport_month">
...
<span class="text-danger" id="transport_month_error"></span>
                                                            </div>
                                                        </div>
...
<div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <select class="form-control year" id="transport_year" name="transport_year">
    <option value=''>--Select Year--</option>
    <option selected value='<?php echo $a= date("Y");?>'><?php echo $a= date("Y");?></option>
    <option value='<?php echo $a= date("Y")-1;?>'><?php echo $a= date("Y")-1;?></option>
<option value='<?php echo $a= date("Y")+1;?>'><?php echo $a= date("Y")+1;?></option>
...
<span class="text-danger" id="transport_amount_more_error"></span>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                ...
                                <div id="configDue" class="modal fade" role="dialog">
                                    <div class="modal-dialog">
                                        <div class="modal-content" style="width:600px;">
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                <h4 class="modal-title text-center"><b>Specify</b> Due Amount</h4>
                                            </div>
                                            <div class="modal-body text-center">
                                            <p> Below details will be appended in Reciept. If it is not required than you can leave it.</p>
                                            <table class="text-center" style="margin: 0 auto;">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td><input id="due-text" value="Due"/></td>
                                                        <td><input id="due-amount" value="0" type="number"></td>
                                                        <td><input id="due-paid" value="0" type="number"></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            </div>
                                            <div class="modal-footer">
                                                ...
                                                <button type="button" class="btn btn-default save-due"><?php echo $this->lang->line('save'); ?></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <script type="text/javascript">
                                    $(document).on('click', '.save_button', function (e) {
                                        ...
                                        var data =  {date: date, type: feetype, amount: amount,amount_paid: amount_paid, amount_discount: amount_discount, amount_fine: amount_fine, description: description, fee_master_id: fee_master_id, student_session_id: student_session_id, payment_mode: payment_mode, guardian_phone: guardian_phone};
                                        invoiceno
                                        if(!isNaN(invoiceno)){
                                           data.id=invoiceno; 
                                        }
                                        console.log(data);
                                        $.ajax({
                                            url: '<?php echo site_url("studentfee/add_Ajaxfee") ?>',
                                            type: 'post',            
                                            data: data,
                                            dataType: 'json',
...
var transport_month = $('#transport_month').val();
var transport_year = $('#transport_year').val();
var fees_per_month= $('#fees_per_month').val();
                                        ...
                                        $.ajax({
                                            url: '<?php echo site_url("studentfee/add_AjaxTransportfee") ?>',
                                            type: 'post',          
                                            data: {date: transport_date, amount: transport_amount, amount_discount: transport_amount_discount, amount_fine: transport_amount_fine, description: description, student_session_id: student_session_id, payment_mode_transport: payment_mode, Month: transport_month, Year: transport_year,fees_per_month : fees_per_month},
                                            dataType: 'json',
                                            success: function (response) {
                                                $this.button('reset');
                                                if (response.status == "success") {
                                ...
                                <script type="text/javascript">
                                    $(document).ready(function () {
                                        ...
                                        $(document).on('click', '.save-due', function () {
                                            $('#configDue').data('due',true);
                                            $('#configDue').modal("hide");
                                        });
                                        $('#configDue').on("hide.bs.modal",function(){
                                            var forwardDue = false;
                                            var dueData = {};
                                            var forwardDue = $('#configDue').data('due');
                                            if(forwardDue){
                                                var _text = $('#due-text').val();
                                                var _amount = $('#due-amount').val();
                                                var _paid = $('#due-paid').val();
                                                dueData = {'text':_text,'amount':_amount,'paid':_paid};
                                            }
                                            print_reciept(dueData);
                                        });
                                    });
                                    function print_reciept(dueData){
                                            var array_to_print = [];
                                            array_to_print.push({"due":dueData});
                                    ...
                                    $(document).ready(function () {
                                        ...
                                        $(document).on('click', '.revert-transportfee', function () {
                                            ...
                                            swal({
                                                ...
                                                {
                                                    type: "post",
                                                    url: '<?php echo site_url("studentfee/deleteTransportFee") ?>',
                                                    data: "feeid=" + payment_id,
                                                    success: function (data) {
                                                    }
                                                }
