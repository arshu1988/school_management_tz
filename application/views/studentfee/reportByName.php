                ...
                if (isset($student_due_fee)) {
                    ...
                    <section class="invoice" style="margin: 10px 15px;">                        
                        ...
                        <div class="row">                           
                            ...
                            <div class="col-md-6">
                                <p class="lead"><?php echo $this->lang->line('balance_description1'); ?><?php echo $this->lang->line('balance_details'); ?></p>
                        ...
                        <div class="row no-print">
                            <div class="col-xs-12">                               
                                <a class="btn btn-primary pull-right" href="<?php echo base_url(); ?>studentfee/addfee/<?php echo $student_id; ?>"><i class="fa fa-credit-card"></i>  <?php echo $this->lang->line('collect_fees'); ?></a>
                                <a href="<?php echo base_url(); ?>report/pdfStudentFeeRecord/<?php echo $class_id; ?>/<?php echo $section_id ?>/<?php echo $student_id; ?>" class="btn bg-orange pull-right" style="margin-right: 5px;"><i class="fa fa-download"></i>  <?php echo $this->lang->line('download_pdf'); ?></a>
                            </div>
                        </div>
                    </section>
                    <?php
