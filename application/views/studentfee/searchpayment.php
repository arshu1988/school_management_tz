                                ...
                                <form role="form" action="<?php echo site_url('studentfee/searchpayment') ?>" method="post" class="form-inline">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-">
                                            ...
                                            <input id="paymentid" name="paymentid" placeholder="" type="text" class="form-control date"  value="<?php echo set_value('paymentid'); ?>"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-3">
                                    ...
                                    if (empty($feeList)) {
                                        ...
                                        foreach ($feeList as $key => $value) {                                           
                                            ...
                                            <tr>
                                                ...
                                                <td class="pull-right">
                                                    <a href="<?php echo base_url() ?>studentfee/addfee/<?php echo $value['id'] ?>" class="btn btn-primary btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('view'); ?>" data-original-title="<?php echo $this->lang->line('view'); ?>">
                                ...
                                <tbody>
                                    ...
                                    if (empty($expenseList)) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="pull-right">
                                                <a href="<?php echo base_url() ?>studentfee/addfee/<?php echo $expenseList['id'] ?>" class="btn btn-primary btn-xs" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('view'); ?>">
                                                    <i class="fa fa-list-alt"></i> <?php echo $this->lang->line('view'); ?>
                                                </a>
                                            </td>
                                        </tr>
