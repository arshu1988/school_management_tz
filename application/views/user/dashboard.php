                ...
                <div class="col-md-9">
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-pane" id="fee">
                            <button type='button' class="btn btn-default btn-sm pull-right no-print" onclick="printDiv('#fee');"><i class="fa fa-print"></i></button>
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($student_due_fee as $key => $fee) {
                                            ...
                                            $cls = "";
                                            $total_row = "xxx";
                                            $payment_status = "<span class='label pull-right bg-green'>".$this->lang->line('paid')."</span>";
                                            if ($fee['date'] == "xxx") {
                                                $cls = "text-red";
                                                $payment_status = "<span class='label pull-right bg-red'>".$this->lang->line('unpaid')."</span>";
                                            } else {
                                                                    ...
                                                                    <td class="text text-center">
                                                                        ...
                                                                        if ($result_v['attendence'] == "pre") {
                                                                            ...
                                                                            if ($get_marks_student < $passing_marks_student) {
                                                                                ...
                                                                                echo "<span class='label pull-right bg-green'>".$this->lang->line('fail')."</span>";
                                                                            }
                                                                        } else {
                                                                            echo "<span class='label pull-right bg-red'>".$this->lang->line('fail')."</span>";
                                                                            $s++;
