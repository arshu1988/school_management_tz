...
class feetype extends Admin_Controller {
    ...
    function index() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('feetype/feetypeList', $data);
    ...
    function view($id) {
        ...
        $this->load->view('layout/header', $data);
        $this->load->view('feetype/feetypeShow', $data);
        $this->load->view('layout/footer', $data);
    }
    ...
    function create() {
        ...
        if ($this->form_validation->run() == FALSE) {
            $this->load->view('layout/header', $data);
            $this->load->view('feetype/feetypeCreate', $data);
            $this->load->view('layout/footer', $data);
        } else {
            $data = array(
    ...
    function edit($id) {
        ...
        if ($this->form_validation->run() == FALSE) {
            $this->load->view('layout/header', $data);
            $this->load->view('feetype/feetypeEdit', $data);
            $this->load->view('layout/footer', $data);
        } else {
            $data = array(
                'id' => $id,
